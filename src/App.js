...
function App() {
  ...
  return (
    <div className="w-[100vw] h-[100vh] flex items-center justify-center flex-col gap-10 bg-[#344151]">
    <div className="text-2xl font-medium text-[#0398d4]">Incremen & Decrement</div>
